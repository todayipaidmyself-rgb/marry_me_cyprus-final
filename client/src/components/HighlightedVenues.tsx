...
// Paths match exact filenames in client/public/highlighted-venues/
const venues = [
  {
    name: "Alassos",
    slug: "alassos",
    image: "/highlighted-venues/Alassos.jpg",
  ...
  },
  {
    ...
    slug: "atlantida",
    image: "/highlighted-venues/Atlantinda.jpg",
  ...
  },
  {
    ...
    image: "/highlighted-venues/Coral-residence.jpg",
  ...
  },
  {
    name: "Elea Estate",
    slug: "elea-estate",
    image: "/highlighted-venues/Elea-Estate.jpg",
  ...
  },
  {
    name: "L'Chateau",
    slug: "lchateau",
    image: "/highlighted-venues/L'chateau.jpg",
  ...
  },
  {
    name: "Liopetro",
    slug: "liopetro",
    image: "/highlighted-venues/Liopetro.jpg",
  ...
  },
  {
    name: "Minthis",
    slug: "minthis",
    image: "/highlighted-venues/Minthis.jpg",
  ...
  },
  {
    ...
    image: "/highlighted-venues/Paliomonastiros.jpg",
  ...
  },
  {
    name: "Vasilias",
    slug: "vasilias",
    image: "/highlighted-venues/Vasilias.jpg",
        ...
        {venues.map(venue => (
          ...
          >
            ...
            <div className="p-6 md:p-7">
              <p className="text-white/80 leading-relaxed mb-5">{venue.intro}</p>
              <details className="group border-t border-white/10 pt-4">
                <summary className="list-none cursor-pointer text-sm uppercase tracking-[0.18em] text-white/70 group-open:text-white transition-colors">
